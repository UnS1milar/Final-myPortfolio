...
function Experience() {
  ...
  return (
    <div className="relative">
      <div className="hideXP w-full bg-gradient-to-r from-white via-blue-50 to-gray-50 pb-4 h-36 top-0 absolute flex justify-center items-end z-10 text-3xl lg:text-5xl text-headline font-josefin dark:bg-gradient-to-r dark:from-black dark:via-gray-900 dark:to-black dark:text-headline2">
        Educational Background
      </div>
      <div className="title2 hideXP absolute bottom-[370px] flex w-full font-josefin items-center justify-center bg-gradient-to-r from-white via-blue-50 to-gray-50 h-24 max-md:bottom-[410px] text-2xl sm:text-3xl lg:text-5xl dark:bg-gradient-to-r dark:from-black dark:via-gray-900 dark:to-black dark:text-headline2">
        Work Experience
      </div>
      <div className="timeline pt-40">
        <div className="container left-container hideXP ">
          <img
            ...
            alt="elem logo"
          />
          <div className="text-box shadow-custom-dark  dark:bg-white dark:bg-opacity-5 dark:backdrop-blur-xl dark:shadow-custom-light dark:border-white dark:text-headline2 ">
            ...
            <span className="left-container-arrow dark:border-l-background"></span>
          </div>
        </div>
        ...
        <div className="container right-container hideXP">
          <img
            ...
            alt="hs logo"
          />
          <div className="text-box shadow-custom-dark dark:bg-white dark:bg-opacity-5 dark:backdrop-blur-md dark:shadow-custom-light dark:border-white dark:text-headline2">
        ...
        <div className="container right-container hideXP mt-24">
